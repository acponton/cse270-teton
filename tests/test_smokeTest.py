...
class TestSmokeTest():
  ...
  def test_4Navigatetothejoinpage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Ponton")
    self.driver.find_element(By.NAME, "bizname").send_keys("ACPS")
  ...
  def test_5Navigatetotheadminpage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("andrea_ponton")
